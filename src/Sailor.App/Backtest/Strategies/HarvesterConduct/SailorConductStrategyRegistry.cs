...
public static class SailorConductStrategyRegistry
{
    ...
    private static SailorStrategyProfile CreateBuiltInProfile(string normalized)
    {
        return normalized switch
        {
            "v21-15minutes" => CreateProfile(normalized, 0.10m, 0.12m, 50_000, 0.70m, false, false, false, 0, 945, 955, 20, 40, 20) with { UseConductExits = false },
            "v23-5minutes" => CreateProfile(normalized, 0.14m, 0.14m, 60_000, 0.80m, false, false, false, 0, 945, 955, 18, 35, 20) with { UseConductExits = false },
            "v24-5minutes" => CreateProfile(normalized, 0.16m, 0.14m, 65_000, 0.85m, false, false, false, 0, 945, 955, 18, 35, 20) with { UseConductExits = false },
            "v22-15minutes" => CreateProfile(normalized, 0.12m, 0.14m, 50_000, 0.75m, false, false, false, 0, 945, 955, 20, 40, 20) with { UseConductExits = false },
            "v16-sqzbreakout" => CreateProfile(normalized, 0.18m, 0.18m, 75_000, 1.00m, true, true, false, 3, 945, 955, 20, 40, 20),
            "v13" => CreateProfile(normalized, 0.15m, 0.16m, 50_000, 0.80m, true, true, false, 2, 945, 955, 20, 40, 20),
            "v10-hybrid" => CreateProfile(normalized, 0.12m, 0.16m, 40_000, 0.70m, false, false, false, 3, 945, 955, 20, 40, 20),
            "v17-hybridflow" => CreateProfile(normalized, 0.12m, 0.18m, 40_000, 0.65m, true, false, false, 3, 945, 955, 20, 40, 20),
            "v2-conduct" => CreateProfile(normalized, 0.12m, 0.15m, 50_000, 0.75m, true, true, false, 2, 945, 955, 20, 40, 20),
            "v18-silver" => CreateProfile(normalized, 0.10m, 0.15m, 35_000, 0.70m, false, false, false, 3, 945, 955, 20, 35, 20),
            "v1-first" => CreateProfile(normalized, 0.20m, 0.20m, 30_000, 0.60m, false, false, false, 2, 945, 955, 20, 30, 20),
            ...
            "v19-purplecloud" => CreateProfile(normalized, 0.18m, 0.18m, 75_000, 1.00m, true, true, false, 3, 945, 955, 20, 40, 20),
            "v15-shortcap" => CreateProfile(normalized, 0.10m, 0.15m, 25_000, 0.80m, false, false, false, 3, 945, 955, 20, 35, 20),
            "v14-smallcap" => CreateProfile(normalized, 0.10m, 0.16m, 20_000, 0.65m, false, false, false, 2, 945, 955, 20, 40, 20),
            "v20-gen001-choppyshield" => CreateProfile(normalized, 0.08m, 0.12m, 35_000, 0.70m, true, false, false, 3, 945, 955, 20, 30, 20),
            "v12" => CreateProfile(normalized, 0.14m, 0.16m, 45_000, 0.75m, true, false, false, 2, 945, 955, 20, 40, 20),
            "harvester-conduct-v9" => CreateProfile(normalized, 0.18m, 0.18m, 100_000, 1.00m, true, true, false, 3, 945, 955, 20, 40, 20),
