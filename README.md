...
## SAILOR-012 HTML strategy and trades report

SAILOR-012 adds an HTML report command with two tables:
...
Run all Sailor and Harvester-style conduct profiles on the small-cap universe:

```bash
dotnet run --project src/Sailor.App/Sailor.App.csproj -- html-report 1m smallcaps
```

Limit to the first 20 symbols with local CSV data:
